...
public class Main {
    public static void main(String[] args) throws IOException {
        List<Info> mainBase = InfoLoader.loadInfosFromKommocsv(List.of(CsvField.PHONE)); //основная база
        mainBase = InfoListUtil.uniqValuesByPhoneNumber(mainBase);
        //List<Info> countGreaterThan = InfoListUtil.filterByCountGreaterOrEqualThan(mainBase, 3);
        ...
        InfoSaver.saveInfos("sets_diff_result.csv", intersectionInfo, List.of(CsvField.PHONE), "\t");
    }
}